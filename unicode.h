...
using vector_pair_uint32_uint32 = std::vector<std::pair<uint32_t, uint32_t>>;
STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, digit_ranges)
    {
...
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, digit_ranges)
#define digit_ranges digit_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, letter_ranges)
{
...
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, letter_ranges)
#define letter_ranges letter_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, whitespace_ranges)
    {
        {0x9, 0xD},       {0x1C, 0x20},     {0x85, 0x85},     {0xA0, 0xA0},
        {0x1680, 0x1680}, {0x2000, 0x200A}, {0x2028, 0x2029}, {0x202F, 0x202F},
        {0x205F, 0x205F}, {0x3000, 0x3000},
    };
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, whitespace_ranges)
#define whitespace_ranges whitespace_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, accent_mark_ranges)
{
...
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, accent_mark_ranges)
#define accent_mark_ranges accent_mark_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, punctuation_ranges)
{
...
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, punctuation_ranges)
#define punctuation_ranges punctuation_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, symbol_ranges)
{
...
STATIC_OBJ_DEF_END(vector_pair_uint32_uint32, symbol_ranges)
#define symbol_ranges symbol_ranges_()

STATIC_OBJ_DEF_BEGIN(vector_pair_uint32_uint32, control_ranges)
{
...
STATIC_OBJ_DEF_END(vector_pair_uint32_t_uint32_t, control_ranges)
#define control_ranges control_ranges_()
...
using unordered_map_uint32_int = std::unordered_map<uint32_t, int>;
STATIC_OBJ_DEF_BEGIN(unordered_map_uint32_int, codepoint_types)
    codepoint_type_map();
STATIC_OBJ_DEF_END(unordered_map_uint32_int, codepoint_types)
#define codepoint_types codepoint_types_()
static int codepoint_type(uint32_t cp)
{
    const auto it = codepoint_types.find(cp);
    return it == codepoint_types.end() ? CODEPOINT_TYPE_UNIDENTIFIED
                                       : it->second;
}
...
{
    std::unordered_map<uint8_t, std::string> map = bytes_to_unicode_map_bpe();
    return map.at(byte);
}
...
{
    std::unordered_map<std::string, uint8_t> map = unicode_to_bytes_map_bpe();
    return map.at(utf8);
}
